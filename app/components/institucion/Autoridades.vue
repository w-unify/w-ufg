        ...
        <div class="w-full xl:w-[300px] shrink-0">
          <div class="relative xl:sticky xl:top-[130px] px-10 xl:px-0">
            ...
            <div class="xl:hidden">
              ...
              <button class="swiper-prev-tabs absolute left-0 top-1/2 -translate-y-1/2 z-10 w-8 h-8 bg-[#E5E5E5] rounded-[4px] flex items-center justify-center shadow-sm">
                <svg class="w-3 h-3 rotate-180" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                </svg>
              </button>
              <button class="swiper-next-tabs absolute right-0 top-1/2 -translate-y-1/2 z-10 w-8 h-8 bg-[#E5E5E5] rounded-[4px] flex items-center justify-center shadow-sm">
